  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextFormField(
        ...
        style: GoogleFonts.inter(fontWeight: FontWeight.w500,fontSize:FontSize1.thirteen.dp,color: ColorResource.color232323),
        ...
        decoration: InputDecoration(
          filled: true,
            ...
            suffixIcon: showIcon==true? GestureDetector(
              onTap: onTapSuffix,
                child: Icon(
                  obscureText ==true? Icons.visibility_outlined:Icons.visibility_off_outlined,
                  color:ColorResource.colorADAFB3,size: 30,
                )):null,
